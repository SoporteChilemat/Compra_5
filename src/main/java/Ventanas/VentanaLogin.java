...
import static Ventanas.VentanaPrincipal.cargar;
...
public class VentanaLogin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPasswordField1.setText("15975357951");
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        dialogLogin = new VentanaUsuario(ventanaPrincipal, true);
        dialogLogin.setLocationRelativeTo(ventanaPrincipal);
    ...
    public static void login() {
        try {
            ...
            Boolean consultaUsuario = consultaUsuario(usuario, contraseña);
            if (consultaUsuario) {
                vl.dispose();
//                cargar();
            } else {
